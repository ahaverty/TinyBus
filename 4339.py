#!/usr/bin/python
#
# TINY BUS 4339 realtime stop information for
# 4x20 OLED display
#
# Author : Alan Haverty
...
#			main()
	...
	#lcd_string("142 Port Tun... 7min")
  	#lcd_byte(LCD_LINE_4, LCD_CMD)
	#lcd_string("102 v.Kinsealy 12min")
	#lcd_byte(LCD_LINE_1, LCD_CMD)
	#lcd_string("MAGIC MAN")
...
#	for i in range(90,254):
#		cur_spot=i
#		lcd_byte(cur_spot,LCD_CMD)
#		lcd_string("!!IT WORKS!!---")	
#		time.sleep(0.5)
